...
#[doc = r" Value of the field"]
pub struct CH10WAITSTATUSR {
    bits: bool,
}
impl CH10WAITSTATUSR {
    #[doc = r" Value of the field as raw bits"]
    #[inline]
    pub fn bit(&self) -> bool {
        self.bits
...
#[doc = r" Value of the field"]
pub struct CH11WAITSTATUSR {
    bits: bool,
}
impl CH11WAITSTATUSR {
    #[doc = r" Value of the field as raw bits"]
    #[inline]
    pub fn bit(&self) -> bool {
        self.bits
...
impl R {
    ...
    #[inline]
    pub fn ch6waitstatus(&self) -> CH6WAITSTATUSR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 6;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
    pub fn ch7waitstatus(&self) -> CH7WAITSTATUSR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 7;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
    pub fn ch8waitstatus(&self) -> CH8WAITSTATUSR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 8;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
    pub fn ch9waitstatus(&self) -> CH9WAITSTATUSR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 9;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
    pub fn ch10waitstatus(&self) -> CH10WAITSTATUSR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 10;
            ((self.bits >> OFFSET) & MASK as u32) != 0
        };
        CH10WAITSTATUSR { bits }
    }
    #[doc = "Bit 11 - Channel 11 Wait on Request Status"]
    #[inline]
    pub fn ch11waitstatus(&self) -> CH11WAITSTATUSR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 11;
            ((self.bits >> OFFSET) & MASK as u32) != 0
        };
        CH11WAITSTATUSR { bits }
    }
}
