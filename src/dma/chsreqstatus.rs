...
#[doc = r" Value of the field"]
pub struct CH10SREQSTATUSR {
    bits: bool,
}
impl CH10SREQSTATUSR {
    #[doc = r" Value of the field as raw bits"]
    #[inline]
    pub fn bit(&self) -> bool {
        self.bits
...
#[doc = r" Value of the field"]
pub struct CH11SREQSTATUSR {
    bits: bool,
}
impl CH11SREQSTATUSR {
    #[doc = r" Value of the field as raw bits"]
    #[inline]
    pub fn bit(&self) -> bool {
        self.bits
...
impl R {
    ...
    #[inline]
    pub fn ch6sreqstatus(&self) -> CH6SREQSTATUSR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 6;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
    pub fn ch7sreqstatus(&self) -> CH7SREQSTATUSR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 7;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
    pub fn ch8sreqstatus(&self) -> CH8SREQSTATUSR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 8;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
    pub fn ch9sreqstatus(&self) -> CH9SREQSTATUSR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 9;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
    pub fn ch10sreqstatus(&self) -> CH10SREQSTATUSR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 10;
            ((self.bits >> OFFSET) & MASK as u32) != 0
        };
        CH10SREQSTATUSR { bits }
    }
    #[doc = "Bit 11 - Channel 11 Single Request Status"]
    #[inline]
    pub fn ch11sreqstatus(&self) -> CH11SREQSTATUSR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 11;
            ((self.bits >> OFFSET) & MASK as u32) != 0
        };
        CH11SREQSTATUSR { bits }
    }
}
