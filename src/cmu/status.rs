...
impl R {
    ...
    #[doc = "Bit 15 - USBC HFCLK Selected"]
    #[inline]
    pub fn usbchfclksel(&self) -> USBCHFCLKSELR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 15;
            ((self.bits >> OFFSET) & MASK as u32) != 0
