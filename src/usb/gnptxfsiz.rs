...
#[doc = r" Value of the field"]
pub struct NPTXFINEPTXF0DEPR {
    bits: u16,
}
impl NPTXFINEPTXF0DEPR {
    #[doc = r" Value of the field as raw bits"]
    #[inline]
    pub fn bits(&self) -> u16 {
        self.bits
...
#[doc = r" Proxy"]
pub struct _NPTXFINEPTXF0DEPW<'a> {
    w: &'a mut W,
}
impl<'a> _NPTXFINEPTXF0DEPW<'a> {
    #[doc = r" Writes raw bits to the field"]
    #[inline]
    pub unsafe fn bits(self, value: u16) -> &'a mut W {
...
impl W {
    ...
    #[doc = "Bits 0:9 - Non-periodic Transmit RAM Start Address host only"]
    #[inline]
    pub fn nptxfstaddr(&mut self) -> _NPTXFSTADDRW {
        _NPTXFSTADDRW { w: self }
    }
    #[doc = "Bits 16:31 - Non-periodic TxFIFO Depth host only / IN Endpoint TxFIFO 0 Depth device only"]
    #[inline]
    pub fn nptxfineptxf0dep(&mut self) -> _NPTXFINEPTXF0DEPW {
        _NPTXFINEPTXF0DEPW { w: self }
    }
}
