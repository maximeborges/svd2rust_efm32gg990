...
#[doc = r" Proxy"]
pub struct _BUENTHRESW<'a> {
    w: &'a mut W,
}
impl<'a> _BUENTHRESW<'a> {
...
#[doc = r" Proxy"]
pub struct _BUENRANGEW<'a> {
    w: &'a mut W,
}
impl<'a> _BUENRANGEW<'a> {
    #[doc = r" Writes raw bits to the field"]
    #[inline]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
        const MASK: u8 = 0x03;
...
impl R {
    ...
    #[doc = "Bits 0:2 - \"\""]
    #[inline]
    pub fn buenthres(&self) -> BUENTHRESR {
        let bits = {
            const MASK: u8 = 0x07;
            const OFFSET: u8 = 0;
    ...
    #[doc = "Bits 3:4 - \"\""]
    #[inline]
    pub fn buenrange(&self) -> BUENRANGER {
        let bits = {
            const MASK: u8 = 0x03;
            const OFFSET: u8 = 3;
            ((self.bits >> OFFSET) & MASK as u32) as u8
...
impl W {
    ...
    #[doc = "Bits 0:2 - \"\""]
    #[inline]
    pub fn buenthres(&mut self) -> _BUENTHRESW {
        _BUENTHRESW { w: self }
    }
    #[doc = "Bits 3:4 - \"\""]
    #[inline]
    pub fn buenrange(&mut self) -> _BUENRANGEW {
        _BUENRANGEW { w: self }
    }
    #[doc = "Bits 5:6 - Power connection configuration when not in Backup mode"]
    #[inline]
