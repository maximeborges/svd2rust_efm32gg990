...
#[doc = r" Proxy"]
pub struct _SCANCOMPLETEW<'a> {
    w: &'a mut W,
}
impl<'a> _SCANCOMPLETEW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
impl W {
    ...
    #[doc = "Bit 16 - \"\""]
    #[inline]
    pub fn scancomplete(&mut self) -> _SCANCOMPLETEW {
        _SCANCOMPLETEW { w: self }
    }
    #[doc = "Bit 17 - \"\""]
    #[inline]
    pub fn dec(&mut self) -> _DECW {
        _DECW { w: self }
    }
    #[doc = "Bit 18 - \"\""]
    #[inline]
    pub fn decerr(&mut self) -> _DECERRW {
        _DECERRW { w: self }
    }
    #[doc = "Bit 19 - \"\""]
    #[inline]
    pub fn bufdatav(&mut self) -> _BUFDATAVW {
        _BUFDATAVW { w: self }
    }
    #[doc = "Bit 20 - \"\""]
    #[inline]
    pub fn buflevel(&mut self) -> _BUFLEVELW {
        _BUFLEVELW { w: self }
    }
    #[doc = "Bit 21 - \"\""]
    #[inline]
    pub fn bufof(&mut self) -> _BUFOFW {
        _BUFOFW { w: self }
    }
    #[doc = "Bit 22 - \"\""]
    #[inline]
    pub fn cntof(&mut self) -> _CNTOFW {
        _CNTOFW { w: self }
    }
}
